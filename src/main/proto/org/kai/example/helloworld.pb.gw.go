...
func request_HelloWorldService_Greeting_0(ctx context.Context, marshaler runtime.Marshaler, client HelloWorldServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterHelloWorldServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client HelloWorldServiceClient) error {
	...
	mux.Handle("POST", pattern_HelloWorldService_Greeting_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_HelloWorldService_Greeting_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_HelloWorldService_Greeting_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_HelloWorldService_Greeting_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "greeting"}, ""))
)

var (
	forward_HelloWorldService_Greeting_0 = runtime.ForwardResponseMessage
)
